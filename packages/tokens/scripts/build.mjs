/**
 * @backdoor_est/etkan-ui-tokens build.
...
const index = [
  ...
  "   Import this once in your app: `import \"@backdoor_est/etkan-ui-tokens\";` (bundlers)",
...
console.log(`@backdoor_est/etkan-ui-tokens: built css/ (${ORDER.length} files + index.css)`);
